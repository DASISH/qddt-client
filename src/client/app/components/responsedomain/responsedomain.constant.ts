...
export const PredefinedColumns: any = {
  'SCALE': [{ 'label': 'Name', 'name': 'name', 'sortable': true, 'direction': '' },
  ...
  'LIST': [{ 'label': 'Name', 'name': 'name', 'sortable': true, 'direction': '' },
    { 'label': 'Description', 'name': 'description', 'sortable': true, 'direction': '' },
    { 'label': 'Number of Codes', 'name': ['managedRepresentation', 'children', 'length'], 'sortable': false }],
  'NUMERIC': [{ 'label': 'Name', 'name': 'name', 'sortable': true, 'direction': '' },
    { 'label': 'Description', 'name': 'description', 'sortable': true, 'direction': '' },
  ...
  'TEXT': [{ 'label': 'Name', 'name': 'name', 'sortable': true, 'direction': '' },
    { 'label': 'Description', 'name': 'description', 'sortable': true, 'direction': '' },
